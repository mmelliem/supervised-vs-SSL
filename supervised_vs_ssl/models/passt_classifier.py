...
for i, emb_file in enumerate(embedding_files):
    ...
    try:
        ...
        loaded_count += 1
        if loaded_count <= 5:
            print(f"Loaded {emb_file}, label: {label}, emb shape: {emb.shape}")
...
# Train MLPClassifier (uses cross-entropy loss)
...
print("Script finished. If you see this, MLPClassifier worked.")